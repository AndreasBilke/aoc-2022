...
impl MonkeyTest {
    pub fn from(divider_line: &str, true_line: &str, false_line: &str) -> Self {
        ...
        let divider: i128 = divider_line.last().expect("No divider found").parse().expect("Divider is not a number");
    ...
    pub fn evaluate(&self, number: i128) -> usize {
